...
pins  = { right: [4, 18], left: [7, 8] } 

# When not running on an actual RPi, you should add the ":stubbed" param like this
# robot = Robot.new pins, :stubbed
robot = Robot.new pins
...
# called by XHR when the user presses one of the arrows of the joystick to set the robot in motion
